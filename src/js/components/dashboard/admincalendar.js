        ...
        if(this.state.eventdescription===''){
            ...
            axios.get(COMPANY_API_URL, {
                ...
                params: {
                    ...
                    param4: this.state.eventtype.toLowerCase(),
                    param5: this.state.eventdescription
                }
            })
                .then(response => {
    ...
    handleEditEvent(event){
        ...
        if(this.state.eventdescription===''){
            ...
            axios.get(COMPANY_API_URL, {
                ...
                params: {
                    param1: "EditEvent",
                    param2: date.toString()+","+this.state.beforeEditDate,
                    param3: localStorage.getItem("adminname"),
                    param4: this.state.eventtype.toLowerCase()+","+this.state.beforeEditEventType.toLowerCase(),
                    param5: this.state.eventdescription+"stntmaniiac_seperating_two_descriptions"+this.state.beforeEditDescription
                }
            })
                .then(response => {
